...
<html>
	<head>
		...
		<!-- title part -->
		<title>dosms final prev list page</title>
		
		<!-- javascript part -->
		<script type="text/javascript">
			function goCal() {
				var frm = document.forms.finalMenuList;
				frm.action = '<c:url value="/finalGoCal.do" />';
				frm.submit();
			}
			
			function goDes() {
				var frm = document.forms.finalMenuList;
				frm.action = '<c:url value="/finalGoDes.do" />';
				frm.submit();
			}
			
			function goList() {
				var frm = document.forms.finalMenuList;
				frm.action = '<c:url value="/finalGoList.do" />';
				frm.submit();
			}
		</script>
					...
					<footer>
						<table height="30" width="100%" style="margin-top:1%">
							<tr>
								...
								<td style align="right"><c:out value="${finname}"/></td>
							</tr>
						</table>
