...
<html>
	<head>
		...
		<script type="text/javascript">
			function doCheckFinal() {
				var frm = document.forms.finalForm;
				
				frm.action = '<c:url value="/Action/doCheckFinal.do" />';
				frm.submit();
			}
			
			function check_all() {
				finalForm.first.checked = true;
				finalForm.second.checked = true;
				finalForm.third.checked = true;
				finalForm.forth.checked = true;
				finalForm.fifth.checked = true;
			}
	...
	<body class="is-loading">
		<form commandName='finalForm' name='finalForm' method="post" enctype="multipart/form-data">
			<!-- Wrapper -->
			<div id="wrapper">
				...
				<section id="main">
					...
					<footer>
						...
						<div id="submitbox" style="width: 100%; text-align: center; position: relative; left: 0; z-index: 3; display: none;">
							<br/>
							<input class="submit" type="button" value='제출 하기' onClick='doCheckFinal();'/>
						</div>
